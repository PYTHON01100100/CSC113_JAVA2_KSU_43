...
public class connect2 {
    public static void main(String[] args) {
    	try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/company", "root", "123456");
            ...
            ResultSet rs = stmt.executeQuery("select * from emplooye");
            ...
            while(rs.next()) {
           	 String Stuid=rs.getString("SSN");
           	 String natID=rs.getString("Age");
           	 String name=rs.getString("Salary");
           	 String maj=rs.getString("Department_Dep_num");
