...
public class Company {
	...
	private Product [] ArrProd;
	private int nbp;
	
	
	public Company(String nn, int size1, int size2)
	{
		name = nn;
		ArrEmp = new Employee[size1];
		nbe = 0;

		ArrProd = new Product[size2];
		nbp = 0;
	...
	{
		if(nbp < ArrProd.length )
		{
			ArrProd[nbp++] = new Product(Pr);
			return true;
		}
		else
			return false;
