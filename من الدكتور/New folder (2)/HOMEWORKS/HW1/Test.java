		...
		do {
			System.out.println("=================================================================================================");
				System.out.println("|| 1. addMark ||"+ "2. deleteMark ||"+  "3. searchMark || "+ "4. display the arrays ||"+ "5. MaximumMark  ||"+ "6. MinimumMark || \n"
						+ "|| 7. MinMaxMark ||"+ "8. countFequency ||"+ "9. AverageMark ||"+ "10. sortMarks ||"+ "11. Exit ||");
				...
				if(i==1) {
					...
					System.out.println("please enter the number of position");
					no=input.nextInt();
					b=a.deleteMark(no);
					if(b==false) {
					...
					System.out.println("the avrage  Marks is "+a.AvrageMarks());
				}
				else if(i==10) {
					a.sortMarks();
					System.out.println("you've done");
